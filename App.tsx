...
import img25 from './images/logo.jpg';

import img30 from './images/20.jpg';
import img31 from './images/21.jpg';
import img32 from './images/22.jpg';
import img33 from './images/23.jpg';
import img34 from './images/24.jpg';
import img35 from './images/25.jpg';
import img36 from './images/nice.jpg';
...
const blogPosts: BlogPost[] = [
  {
    id: '1',
    slug: 'limestone-fire-pit-athabasca',
    title: 'Cozy Limestone Fire Pit & Patio',
    excerpt: 'Transforming a backyard in Athabasca with a custom limestone fire pit and durable patio area. Perfect for summer evenings and family gatherings.',
    date: '2024-05-15',
    image: img3,
    story: [
      'For this project in Athabasca, the homeowners wanted a dedicated space to relax and entertain. We designed a custom limestone fire pit as the centerpiece, surrounded by a durable patio area.',
      'We started by excavating the area to ensure a solid base. Using our skid steer, we graded the land and installed a proper gravel base to prevent settling and frost heaving—a crucial step in our Canadian climate.',
      'The limestone blocks were carefully selected from Pretty Rock Supply to match the natural aesthetics of the property. We used heavy-duty landscape adhesive and proper stacking techniques to ensure the fire pit is safe and long-lasting.',
      'To finish the look, we installed a surrounding mulch bed with edging to keep the area low-maintenance. The result is a beautiful, functional outdoor living space that the family can enjoy for years to come.'
    ],
    tips: [
      {
        title: 'Choose Durable Materials',
        description: 'Limestone is excellent for fire pits as it withstands heat and weather well.'
      },
      {
        title: 'Plan for Drainage',
        description: 'Ensure the fire pit has proper drainage to prevent water accumulation.'
      }
    ],
    qa: [
      {
        question: 'Do you sell the rocks?',
        answer: 'Yes! We stock all kinds of rocks and limestone at Pretty Rock Supply in Athabasca.'
      }
    ]
  },
  {
    id: '2',
    slug: 'driveway-grading-french-drain',
    title: 'Driveway Grading & French Drain Installation',
    excerpt: 'Fixing drainage issues and potholes in Boyle. We graded the driveway and installed a French drain to keep water away from the house foundation.',
    date: '2024-06-02',
    image: img2,
    story: [
      'Water management is key to a long-lasting driveway. This property in Boyle suffered from large potholes and water pooling near the garage.',
      'We brought in our excavation equipment to re-grade the entire driveway, ensuring water flows away from structures. We dug a trench for a French drain system, lined it with geotextile fabric, and filled it with clear stone to facilitate drainage.',
      'After installing the drain, we topped up the driveway with fresh gravel and compacted it for a smooth, solid finish. "Grades, pads, French drains... we love planning in the dirt!"',
      'The homeowner now has a dry, smooth driveway that handles heavy rain without washing out.'
    ],
    tips: [
      {
        title: 'Regular Maintenance',
        description: 'Pot-hole top-ups and grading should be done annually to maintain your driveway.'
      },
      {
        title: 'Proper Slope',
        description: 'A 2% slope is recommended to shed water effectively.'
      }
    ],
    qa: [
      {
        question: 'Can you fix long driveways?',
        answer: ' Absolutely. We have the equipment to handle long rural driveways efficiently.'
      }
    ]
  },
  {
    id: '3',
    slug: 'snow-removal-community',
    title: 'Community Snow Removal & Winter Safety',
    excerpt: 'Keeping Athabasca safe during winter. From residential driveways to donating services for the Community Housing Society.',
    date: '2025-01-10',
    image: img18,
    story: [
      'Winter in Athabasca is no joke! At Done Right Contracting, we take snow removal seriously. This season, we were proud to donate our services to the Athabasca Cares Community Housing Society.',
      'Our team monitors weather closely and deploys immediately after snowfall. We use professional equipment to clear driveways, parking lots, and walkways efficiently, ensuring safety for everyone.',
      '"Yay, we finally got snow!!" is our attitude—we love what we do. Whether it is a quick clear for a senior resident or managing a large commercial lot, we are on it.',
      'Remember, prompt snow removal prevents ice buildup and keeps your property accessible.'
    ],
    tips: [
      {
        title: 'Book Early',
        description: 'Get on our snow removal list before the first big storm hits.'
      }
    ],
    qa: [
      {
        question: 'Do you offer seasonal contracts?',
        answer: 'Yes, we offer monthly contracts or per-visit rates for snow removal.'
      }
    ]
  }
];
      ...
      <div className="lg:hidden flex flex-col bg-stone-100">
        <div className="relative h-screen w-full flex flex-col justify-center items-center px-6 overflow-hidden">
          ...
          <div className="relative z-10 text-center flex flex-col items-center top-[-40px]">
            <span className="text-[#c5a26a] font-bold tracking-[0.2em] text-[10px] md:text-sm uppercase mb-4 animate-[fadeInUp_0.8s_ease-out]">
              Serving Athabasca, Boyle, Grassland & Bison Ridge
            </span>
            <h1 className="text-4xl md:text-6xl font-serif text-white leading-[1.1] animate-[fadeInUp_1s_ease-out] drop-shadow-lg px-2">
              Done Right <br />
              <span className="text-[#c5a26a] italic font-light block mt-2">Contracting Ltd</span>
            </h1>


            <p className="text-white text-base md:text-lg leading-relaxed max-w-[90%] md:max-w-[600px] mx-auto my-6 md:my-8 animate-[fadeInUp_1.3s_ease-out] font-medium drop-shadow-md">
              Professional Landscaping, Excavation & Year-Round Property Maintenance.
              <br />
              "With the right equipment and attitude, anything is possible."
            </p>

            {/* Action Buttons */}
            <div className="flex flex-col gap-4 w-full max-w-[280px] animate-[fadeInUp_1.4s_ease-out]">
              <a
                href="tel:+17805985202"
        ...
        <div className="relative z-30 -mt-8 bg-white rounded-t-[40px] px-6 pt-16 pb-16 shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
          ...
          <div className="absolute -top-12 left-1/2 -translate-x-1/2">
            <div className="relative group">
              ...
              <img
                src={img25}
                alt="Logo Done Right Contracting"
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-serif text-white leading-[1.1] drop-shadow-2xl mb-6 md:mb-8 animate-[fadeInUp_1.2s_ease-out_forwards]">
                Done Right
                <br />
                <span className="italic font-light text-gold-400">Contracting Ltd</span>
              </h1>
              ...
              <p className="text-lg md:text-xl text-gray-200 font-light max-w-2xl border-l-2 border-gold-500 pl-4 md:pl-6 mb-8 md:mb-10 animate-[fadeInUp_1.4s_ease-out_forwards] mx-auto lg:mx-0">
                For years, Done Right Contracting Ltd has been the trusted partner for homeowners and businesses across the region. From building driveways in Bison Ridge to maintaining the local train station, we handle projects big and small with a focus on smart, cost-effective solutions and an unwavering commitment to getting it "Done Right."
              </p>
  ...
  const services = [
    {
      ...
      desc: "Designing and building cozy limestone fire pits, durable driveways, and beautiful, low-maintenance mulch beds. We plan for the future."
    },
    {
      icon: <Shovel className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Excavation & Site Work",
      desc: "We love planning in the dirt! From French drains and grading to filling potholes—we do the dirty work so you don't have to."
    },
    {
      icon: <CheckCircle className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Demolition & Handyman",
      desc: "General demolition, fence building, concrete work, sanding, painting, and repairs. No job too small."
    },
    {
      icon: <Leaf className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Snow Removal",
      desc: "Winter specialty service! We proudly keep our community safe, including donating services to the Athabasca Cares shelter."
    },
    {
      icon: <Star className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Pretty Rock Supply",
      desc: "Your local source for rocks, sand, limestone, soils, mulch, and firewood. Stocked right here in Athabasca! (Seasonal)"
    },
    {
      icon: <PencilRuler className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Line Services",
      desc: "Trenching and painting services, plus sweeping and site maintenance for a complete, polished look."
    }
  ];
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-16">
        <RevealOnScroll>
          <div className="relative w-full max-w-lg mx-auto lg:mx-0">
            ...
            <img
              src={img36}
              alt="Work of Done Right Contracting"
            ...
            <div className="absolute -bottom-6 -right-6 md:-bottom-10 md:-right-10 bg-white text-earth-900 p-4 md:p-8 shadow-xl max-w-xs hidden lg:block z-20">
              <p className="font-serif text-lg md:text-2xl italic">"Reliable, creative, and community focused."</p>
              <p className="text-right mt-2 md:mt-4 font-bold text-gold-600 text-xs md:text-sm tracking-widest">— Done Right Contracting</p>
            </div>
          </div>
        </RevealOnScroll>
        ...
        <div className="lg:w-1/2 space-y-6 md:space-y-8 mt-8 lg:mt-0">
          <RevealOnScroll delay={200}>
            <span className="text-gold-500 font-bold tracking-[0.2em] text-xs uppercase">Why Choose Us</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif mt-4 leading-tight">Precision<span className="text-gold-500 italic"> from the Ground Up.</span></h2>

            <p className="text-gray-300 text-base md:text-lg font-light leading-relaxed mt-4 md:mt-6">
              We don’t believe in "standard" fixes for the unique challenges of Alberta’s terrain. From grading 150-foot driveways in Bison Ridge to building custom limestone fire pits with technical drainage, we focus on engineering that lasts. By utilizing our specialized "Wet Rental" model—providing both the heavy machinery and a professional operator—and our own Pretty Rock Supply inventory, we deliver high-end results that stay within your budget. We don’t just move dirt; we build the details that prevent frost damage and ensure long-term stability.
            </p>
            ...
            <div className="flex items-center gap-4 md:gap-6 p-4 md:p-6 bg-white/5 border border-white/10 rounded-sm mt-6 md:mt-8 backdrop-blur-sm hover:bg-white/10 transition-colors">
              <img
                src={img25}
                alt="Logo Done Right Contracting"
                className="w-28 h-19 md:w-48 md:h-32 object-cover border-2 border-gold-500 shadow-md"
              />
              <div>
                <h4 className="text-lg md:text-xl font-serif text-white">Done Right Contracting Ltd</h4>
                <p className="text-gold-500 text-xs font-bold uppercase tracking-widest mb-1 md:mb-2">Also: Pretty Rock Supply</p>
                <p className="text-gray-400 text-xs italic">"One Call or Text gets it done."</p>
              </div>
            </div>

            <div className="space-y-4 md:space-y-6 mt-6 md:mt-8">
              {[
                { title: "Free Quotes", desc: "Call or text +1 780-598-5202 for a free estimate on any of our services." },
                { title: "Versatile Solutions", desc: "From rocks to fire wood, demolition to landscaping - we do it all." },
                { title: "Cost-Effective", desc: "Creative problem-solving to save you money without cutting corners." }
              ].map((item, i) => (
...
const Testimonials = () => {
  ...
  const allReviews = [
    { name: "Athabasca Cares", location: "Athabasca Community Housing Society", rating: 5, time: "Winter Season", text: "We are beyond grateful to Done Right Contracting Ltd for their generous donation of snow removal services to our shelter for the entire winter season. This incredible contribution keeps our shelter accessible and safe. Thank you for being a true community champion!" },
    { name: "Local Resident", location: "Boyle, AB", rating: 5, time: "Recent", text: "Another day, another driveway! The crew is hard at work and does fantastic job. Highly reliable." },
    { name: "Happy Client", location: "Grassland", rating: 5, time: "Summer", text: "From rocks to fire wood and everything in between! They utilize creative solutions that saved us money. It's all in the details." }
  ];
...
const InteractiveMap = () => (
  <div className="w-full h-[300px] md:h-[500px] relative">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d156555.24213745262!2d-113.40026369046033!3d54.71960206195861!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53a3c1f887693991%3A0x286395e5057a1516!2sAthabasca%2C%20AB!5e0!3m2!1sen!2sca!4v1706654400000!5m2!1sen!2sca"
      width="100%"
      height="100%"
      style={{ border: 0 }}
      allowFullScreen
      ...
      title="Location in Athabasca, AB"
...
const HomePage = () => (
  <>
    <SEOHead
      title="Done Right Contracting Ltd – Landscaping & Excavation in Athabasca, AB"
      description="Expert landscaping, excavation, and snow removal in Athabasca, Boyle, Grassland & Bison Ridge. Construction, driveways, material supply, and more. Call (780) 598-5202."
      keywords="landscaping Athabasca, excavation Boyle, snow removal Athabasca, Pretty Rock Supply, Done Right Contracting, gravel pads, fence building, demolition Alberta"
    />
    <Hero />
    <ServicesSection />
    <AboutPreview />
...
const ServicesPage = () => (
  <>
    <SEOHead
      title="Our Services – Landscaping, Excavation & Maintenance in Athabasca"
      description="Complete services from Done Right Contracting: Landscaping, Excavation, Demolition, Snow Removal, Material Supply, and Handyman Services. Serving Athabasca & Area."
      keywords="landscaping services Athabasca, excavation services, snow removal, handyman Athabasca, limestone fire pits"
    />
    <PageHeader
      title="Our Services"
      subtitle="Done Right. Every Time."
    ...
    <section className="py-12 md:py-20 bg-earth-900 text-center text-white">
      <div className="max-w-4xl mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-serif mb-4 md:mb-6">Ready to Get Your Project Going?</h2>
        <p className="text-gray-300 mb-4 text-sm md:text-base">We are a full-service contracting company serving the Athabasca region:</p>
        <ul className="text-gray-300 text-sm md:text-base mb-6 md:mb-8 max-w-2xl mx-auto text-left space-y-2">
          <li>✓ Landscaping & Hardscaping (Driveways, Fire Pits)</li>
          <li>✓ Excavation & grading ("In the dirt")</li>
          <li>✓ Snow Removal (Winter Special)</li>
          <li>✓ Demolition & Handyman Services</li>
          <li>✓ Material Supply (Pretty Rock Supply)</li>
          <li>✓ Line Trenching & Painting</li>
          <li>✓ Site Maintenance & Sweeping</li>
        </ul>
        <p className="text-gold-500 font-bold text-lg mb-6">Call or Text: (780) 598-5202</p>
...
const ProjectsPage = () => (
  <>
    <SEOHead
      title="Projects Gallery – Done Right Contracting Ltd"
      description="View our recent projects in Athabasca and area. Driveways, fire pits, snow removal, and more."
      keywords="landscaping library, Athabasca projects, contracting portfolio"
    />
    <PageHeader
      title="Projects"
      subtitle="Our Work"
    ...
    <div className="bg-stone-50 py-12 md:py-20">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <p className="text-gray-500 italic text-sm md:text-base">"Another day, another driveway."</p>
      </div>
    </div>
  </>
);
...
const AboutPage = () => (
  <>
    <SEOHead
      title="About Us – Done Right Contracting Ltd"
      description="Learn about Done Right Contracting Ltd and Pretty Rock Supply. Community-oriented, hard-working, and serving Athabasca since day one."
      keywords="contractors Athabasca, local business, pretty rock supply, community housing society"
    />
    <PageHeader
      title="About Us"
      subtitle="Our Story"
        ...
        <div className="prose prose-sm md:prose-lg prose-stone mx-auto">
          ...
          <div className="flex flex-col items-center mb-8 md:mb-12">
            ...
            <div className="mt-4 md:mt-6 text-center">
              <h4 className="text-xl md:text-2xl font-serif text-earth-900">Done Right Contracting Ltd</h4>
              <p className="text-gold-500 text-xs md:text-sm font-bold uppercase tracking-widest">Also: Pretty Rock Supply</p>
            </div>
          </div>

          <h3 className="text-2xl md:text-3xl font-serif text-earth-900 mb-4 md:mb-6 text-center">The "Done Right" Philosophy</h3>
          <p className="leading-loose text-gray-600 mb-4 md:mb-6 text-sm md:text-base">
            Owned and operated by Freddy (aka "The guy" for Pretty Rock Supply), we are a full-service, community-oriented contracting company in Athabasca, Alberta. We handle everything from landscaping and excavation to demolition and handyman services.
          </p>
          <p className="leading-loose text-gray-600 mb-4 md:mb-6 text-sm md:text-base">
            We focus on cost-effective simple solutions tailored to your unique challenges. As we say: "With the right equipment and attitude anything is possible." We are proud to serve Athabasca, Boyle, Grassland, Bison Ridge, and surrounding areas.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 py-8 md:py-12 text-center border-y border-gray-200 my-8 md:my-12">
            <div>
              <span className="block text-2xl md:text-4xl font-serif text-gold-500 mb-1 md:mb-2">Local</span>
              <span className="text-xs uppercase tracking-widest text-gray-500">Athabasca Based</span>
            </div>
            <div>
              <span className="block text-2xl md:text-4xl font-serif text-gold-500 mb-1 md:mb-2">Year-Round</span>
            ...
            <div>
              ...
              <span className="text-xs uppercase tracking-widest text-gray-500">Dedication</span>
            </div>
          </div>
          ...
          <div className="bg-stone-50 p-6 md:p-8 rounded-lg mt-8 md:mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
              <div>
                ...
                <a href="tel:+17805985202" className="text-earth-900 hover:text-gold-500 transition-colors font-bold">+1 780-598-5202</a>
              </div>
              <div>
                <Send className="w-6 h-6 text-gold-500 mx-auto mb-2" />
                <a href="mailto:drc.ltd@hotmail.com" className="text-earth-900 hover:text-gold-500 transition-colors">drc.ltd@hotmail.com</a>
              </div>
            </div>
          </div>
        </div>
...
const ContactPage = () => (
  <>
    <PageMeta
      title="Contact & Free Quote – Done Right Contracting Ltd"
      description="Call or Text +1 780-598-5202 in Athabasca for a free quote"
    />
    <PageHeader
      title="Contact"
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Athabasca, Boyle, Grassland & Bison Ridge<br />And surrounding areas in Alberta</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-serif text-lg text-earth-900 mb-2">Call/Text (Preferred)</h4>
                  <a href="tel:+17805985202" className="text-earth-900 hover:text-gold-500 transition-colors font-bold text-lg">+1 780-598-5202</a>
                  <p className="text-gray-600 text-sm mt-1">Free Quotes</p>
                </div>
              </div>
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://www.facebook.com/profile.php?id=100063537015116"
                    target="_blank"
                    rel="noopener noreferrer"
...
const BlogListPage = () => (
  <>
    <SEOHead
      title="Project Stories – Done Right Contracting Ltd"
      description="Tips, updates, and project stories from Done Right Contracting Ltd. See how we get the job done in Athabasca."
      keywords="landscaping tips, snow removal, driveway guides"
    />
    <PageHeader
      title="Blog & Ratgeber"
          ...
          <RevealOnScroll delay={600}>
            <div className="mt-16 md:mt-20 p-8 md:p-12 bg-earth-900 text-white text-center rounded-lg">
              ...
              <p className="text-gray-300 mb-6 md:mb-8">
                As your local contractor in Athabasca, Boyle, and Grassland, we are here to help.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="tel:+17805985202" className="inline-flex items-center px-8 py-4 bg-gold-500 hover:bg-gold-600 text-earth-900 font-bold uppercase tracking-widest transition-colors">
...
const FullGalleryPage = () => {
  ...
  // SEO effect
  useEffect(() => {
    document.title = "Gallery – Our Work | Done Right Contracting Ltd";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', "Browse our gallery: Landscaping, Excavation, and more in Athabasca.");
  }, []);
          ...
          <div className="mt-20 md:mt-28 p-8 md:p-12 bg-stone-50 border-l-4 border-gold-500 rounded-lg">
            <div className="max-w-3xl">
              ...
              <p className="text-gray-600 text-base md:text-lg mb-6 leading-relaxed">
                Every project in this gallery showcases our commitment to quality craftsmanship and beautiful design. From custom pavers and hardscaping to lush plant installations and professional concrete work – discover the possibilities for transforming your outdoor space in Athabasca and surrounding areas.
              </p>
      ...
      <div className="flex flex-col min-h-screen overflow-x-hidden font-sans text-earth-900 selection:bg-gold-500 selection:text-white bg-stone-50">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route path="/locations/:citySlug" element={<LocationPageRouter />} />
          </Routes>
        </main>
        <Footer />
