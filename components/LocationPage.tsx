...
const LocationPage: React.FC<LocationPageProps> = ({ location }) => {
    ...
    useEffect(() => {
        const locationSchema = {
            ...
            "@type": "LocalBusiness",
            "@id": `https://donerightcontracting.ca/locations/${location.slug || location.city.toLowerCase()}#localbusiness`,
            "name": `Done Right Contracting Ltd - ${location.city}`,
            "description": `Professional landscaping, excavation, and snow removal in ${location.city}. Your local partner for outdoor projects in Athabasca area.`,
            "image": "https://donerightcontracting.ca/images/logo.png",
            "telephone": "+17805985202",
            "email": "drc.ltd@hotmail.com",
            "url": `https://donerightcontracting.ca/locations/${location.slug || location.city.toLowerCase()}`,
            "address": {
                "@type": "PostalAddress",
                "streetAddress": "56th",
            ...
            "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": `Contracting Services in ${location.city}`,
            ...
            "parentOrganization": {
                "@type": "Organization",
                "@id": "https://donerightcontracting.ca/#organization",
                "name": "Done Right Contracting Ltd"
            }
        };
    ...
    return (
        <div className="min-h-screen bg-stone-50">
            {/* SEO Head */}
            <SEOHead
                title={`Landscaping, Excavation & Snow Removal ${location.city} | Done Right Contracting Ltd`}
                description={`Expert landscaping, excavation, and contracting services in ${location.city}. Driveways, fire pits, snow removal, and more. Free Quote: 780-598-5202. ${location.description}`}
                keywords={`landscaping ${location.city}, excavation ${location.city}, snow removal ${location.city}, contracting ${location.city}, driveways ${location.city}, Athabasca contractors`}
                canonical={`https://donerightcontracting.ca/locations/${citySlug}`}
            />
                        ...
                        <div>
                            <div className="aspect-w-16 aspect-h-12 rounded-lg overflow-hidden shadow-2xl">
                                <iframe
                                    ...
                                    title={`Map of ${location.city} - Done Right Contracting service area`}
                                ></iframe>
                            </div>
                        </div>
                    </div>
